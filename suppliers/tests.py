...
from rest_framework.test import APITransactionTestCase, APITestCase, APIClient, APIRequestFactory
...
class ProviderTests(AuthenticatedTestCase):
    ...
    def test_get_provider_list(self):
        ...
        Provider.objects.create(name="Gonza", email="gonza@email.com", phone="+5491234567", language="en", currency="USD")
        Provider.objects.create(name="Pablo", email="pablo@email.com", phone="+5499876543", language="es", currency="EUR")
